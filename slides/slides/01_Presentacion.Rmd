---
title: "Importancia del monitoreo satelital en la vigilancia del medio ambiente"
subtitle: "<br/> Marvin J. Quispe Sedano "
author: "Especialista en GIS & Teledetección <br/><br/> <img src='../img/logos_inicio.png' alt='Arcgis' width='100' height='40'> <br/>"
date: "Lima, 2022"
output:
...
## FUNDAMENTOS DEL MONITOREO SATELITAL
...
<iframe width="720" height="380" src="https://www.youtube.com/embed/b4eLTYUcj7k" title="YouTube video player" frameborder="0" allow="accelerometer; autoplay; clipboard-write; encrypted-media; gyroscope; picture-in-picture" allowfullscreen></iframe>
...
<iframe width="720" height="380" src="https://www.youtube.com/embed/JY4psw98sgo" title="YouTube video player" frameborder="0" allow="accelerometer; autoplay; clipboard-write; encrypted-media; gyroscope; picture-in-picture" allowfullscreen></iframe>


### .instructions[¿QUÉ SON LOS GIS?]
...
<img src='img/gis_apps.png' alt='geo-info' width='100%' height='100%' class='center'>

### .instructions[Aplicaciones GIS]

---

class: inverse, center, middle

### IMPORTANCIA DEL MONITOREO SATELITAL DEL MEDIO AMBIENTE
...
<iframe width="720" height="380" src="https://www.youtube.com/embed/pM353KXJ-WU" title="YouTube video player" frameborder="0" allow="accelerometer; autoplay; clipboard-write; encrypted-media; gyroscope; picture-in-picture" allowfullscreen></iframe>

### .instructions[RAMI: Monitoreo de Minería con Radar]
...
<iframe width="720" height="380" src="https://www.youtube.com/embed/3SFQD27tUDs" title="YouTube video player" frameborder="0" allow="accelerometer; autoplay; clipboard-write; encrypted-media; gyroscope; picture-in-picture" allowfullscreen></iframe>

### .instructions[Unidad de Monitoreo Satelital del SERFOR, Perú]
...
<img src='img/midagri_siea.png' alt='geo-info' width='100%' height='100%' class='center'>

### .instructions[Herramientas satelitales del MIDAGRI, Perú]
...
<img src='img/mirave_indeci.jpg' alt='geo-info' width='100%' height='100%' class='center'>

### .instructions[Monitoreo de desastre en Mirave, Tacna, 2019]
...
<img src='img/ACCA_petroleo.jpg' alt='geo-info' width='100%' height='75%' class='center'>

### .instructions[Monitoreo del derrame de petróleo en el mar]
...
<img src='img/aplicaciones.png' alt='geo-info' width='90%' height='100%' class='center'>

### .instructions[Otras Aplicaciones ...]
